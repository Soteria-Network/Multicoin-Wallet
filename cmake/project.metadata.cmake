...
set(DEX_API "kdf_soter")
set(DEX_RPCPORT 27762)
set(DEX_RPC "http://127.0.0.1:27762")
set(DEX_PROJECT_NAME "Soteria-Multicoin-Wallet")
set(DEX_DISPLAY_NAME "Soteria Multicoin Wallet")
set(DEX_MAINTENANCE_TOOL_NAME "Soteria Multicoin Wallet Maintenance Tool")
set(DEX_COMPANY "Soteria Network")
set(DEX_WEBSITE "https://soteria-network.online/")
set(DEX_VERSION "1.0.0")
set(DEX_DISCORD "https://discord.gg/Uv4bBnGc2C")
set(DEX_TWITTER "https://x.com/Soteria_Network")
set(DEX_PRIMARY_COIN "SOTER")                                                    ## Main coin of the DEX, will be enabled by default and will be the default left ticker for trading
...
set(DEX_REPOSITORY_NAME "Soteria-Multicoin-Wallet")
set(DEX_CHECKSUM_API_URL "https://komodo.live/static/checksum.json")
if (APPLE)
    set(DEX_APPDATA_FOLDER "Soteria Multicoin Wallet")
else ()
    set(DEX_APPDATA_FOLDER "Soteria Multicoin Wallet")
endif ()
